# this file contains configured variables for different parts of the project
...
# Parameters related to CUDNN
config.CUDNN = edict()
config.CUDNN.BENCHMARK = True
config.CUDNN.DETERMINISTIC = False
config.CUDNN.ENABLED = True

# Parameters related to Pose_Resnet
POSE_RESNET = edict()
...
POSE_RESNET.HEATMAP_SIZE = [64, 64]  #[width, Height]
POSE_RESNET.SIGMA = 2
...
config.MODEL.IMAGE_SIZE = [256, 256] #[width, Height]
...
# training data augmentation , basic augmentation
...
# Adam optimizer adaptive variable settings
...
#config.TRAIN.END_EPOCH = 140 # for testing purpose Epoch count reduced to 10, for better performance keep epoch greater than 100
